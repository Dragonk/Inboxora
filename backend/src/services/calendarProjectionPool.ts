...
// Node runs directly without any extra loader.
const SOURCE_WORKER = import.meta.url.endsWith('.ts');
const WORKER_URL = new URL(
  SOURCE_WORKER ? './calendarProjectionWorker.ts' : './calendarProjectionWorker.js',
  import.meta.url,
);
