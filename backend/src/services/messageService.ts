    ...
    const threadResult = await query(`
      ...
      deduped AS MATERIALIZED (
        SELECT DISTINCT ON (m.account_id, m.thread_key,
               ...
               m.to_addresses, m.cc_addresses, m.draft_bcc_addresses, m.draft_uid_validity::text AS draft_uid_validity, m.reply_to, m.in_reply_to,
      ...
      SELECT id, uid, folder, message_id, thread_id, thread_key, thread_subject AS subject,
             ...
             to_addresses, cc_addresses, draft_bcc_addresses, draft_uid_validity, reply_to, in_reply_to,
