...
describe('automated series fixtures', () => {
  const base = { canonical_subject: 'Daily digest', from_email: 'no-reply@example.test', headers: { 'auto-submitted': 'auto-generated' }, to_addresses: [{ email: 'me@example.test' }], date: '2026-01-01T00:00:00Z', body_text: 'Hello 1234' };
