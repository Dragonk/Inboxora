...
// Compute the thread_id for an incoming message using account-scoped RFC 5322
// ancestry, with the legacy subject heuristic retained only as an explicit fallback.
