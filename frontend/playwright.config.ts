...
export default defineConfig({
  ...
  testDir: './e2e',
  testMatch: '**/*.spec.ts',
  testIgnore: ['**/chromium-smoke.ts', '**/fixtures.ts', '**/real-app-fixtures.ts', ...(isRealApp ? [] : ['**/real-app.spec.ts'])],
  timeout: 30_000,
  ...
  projects: [
    ...
    { name: 'chromium-tablet', testMatch: '**/v3-*.spec.ts', use: { ...devices['Desktop Chrome'], viewport: { width: 1024, height: 768 } } },
