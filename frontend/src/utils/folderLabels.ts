...
export function folderRole(folder, mappings: Record<string, unknown> | null | undefined = {}) {
...
export function folderLabel(folder, t, mappings: Record<string, unknown> | null | undefined = undefined) {
  const labels = {
