...
export const conversationApi = {
  ...
  body: (conversationId, logicalMessageId, signal) => api.get(`/mail/conversations/${encodeURIComponent(conversationId)}/logical-messages/${encodeURIComponent(logicalMessageId)}/body`, { signal }),
