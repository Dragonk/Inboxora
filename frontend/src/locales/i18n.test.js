...
const SAME_VALUE_ALLOWED = {
  ...
  'conversation.account': [['de', 'pl'], ['en', 'it']],
  'conversation.bcc': [['de', 'en']],
  'conversation.cc': 'any',
  ...
  'conversation.copies': [['en', 'fr']],
  'conversation.copyCount_one': [['es', 'it']],
  'conversation.copyCount_few': [['en', 'fr']],
  'conversation.copyCount_many': [['en', 'fr']],
  'conversation.date': [['en', 'fr'], ['it', 'pl']],
  'conversation.diagnosticsCopyCount': [['en', 'fr']],
  'conversation.diagnosticsKind': [['de', 'pl'], ['es', 'it']],
  'conversation.diagnosticsNone': 'any',
  'conversation.folder': [['en', 'pl']],
  'conversation.from': [['es', 'fr']],
  'conversation.logicalCount': [['en', 'fr']],
  'conversation.messageCount_one': [['en', 'fr']],
  'conversation.messageCount_few': [['en', 'fr']],
  'conversation.messageCount_many': [['en', 'fr']],
