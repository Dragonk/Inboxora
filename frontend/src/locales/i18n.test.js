 ...
 *     const DYNAMIC_KEYS = new Set([
  // Candidate CE v2 keys retained while adopting upstream locale parity rules.
...
const SAME_VALUE_ALLOWED = {
  ...
  // CE candidate-only keys: values are intentionally shared placeholders during review.
  ...
  // CE v2 keys: EN/PL and placeholder locale values are intentional during CE parity.
  "conversation.accounts": 'any',
  "conversation.apply": 'any',
  "conversation.archive": 'any',
  "conversation.attachment": 'any',
  ...
  'message.via': [['en', 'fr']],
  // Conversation UI terms that are genuinely identical loanwords, abbreviations,
  // punctuation, or shared Romance/Germanic forms — not untranslated sentences.
  'conversation.cc': 'any',
  'conversation.diagnosticsNone': 'any',
  ...
  // "Unknown sender" — identical in en/de/es/fr/it/ru/zhCN; PL has "Nieznany nadawca"
  ...
  // Explicitly shared values verified across current locale corpus.
  "admin.about.license": 'any',
  "admin.accounts.aliases": 'any',
  "admin.accounts.imapPort": 'any',
  "admin.accounts.signatureSection": 'any',
  "admin.accounts.smtpPort": 'any',
  "admin.ai.chatgptModel": 'any',
  "admin.ai.model": 'any',
  "admin.aliases.signatureSection": 'any',
  "admin.aliases.title": 'any',
  "admin.appearance.typography": 'any',
  "admin.folderMappings.archive": 'any',
  "admin.integrations.carddav.serverPh": 'any',
  "admin.integrations.carddav.title": 'any',
  "admin.lock.autoLockMin": 'any',
  "admin.messageList.markReadDelaySeconds": 'any',
  "admin.messageList.markReadDelaySeconds_other": 'any',
  "admin.privacy.addDomainPh": 'any',
  "admin.rules.fieldFrom": 'any',
  "admin.systemEmail.port": 'any',
  "admin.tabs.categories": 'any',
  "admin.tabs.sso": 'any',
  "admin.users.invitePh": 'any',
  "compose.from": 'any',
  "contacts.fields.email": 'any',
  "contacts.fields.phone": 'any',
  "contacts.title": 'any',
  "gtd.state.reference": 'any',
  "messageList.categories.newsletter": 'any',
  "todoist.project": 'any',

  // CE cross-locale placeholder values verified for the candidate corpus.
