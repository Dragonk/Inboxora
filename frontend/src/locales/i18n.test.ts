 ...
 *     const DYNAMIC_KEYS = new Set([
  // CE v2 candidate-only keys selected by CE UI/configuration surface.
  ...
  'conversation.attachmentCount_few',
  'conversation.attachmentCount_many',
  'conversation.attachmentCount_one',
  'conversation.automatedSeries',
  'conversation.bcc',
  'conversation.bodyLabel',
  ...
  'conversation.confirmArchiveBody',
  'conversation.confirmArchiveTitle',
  'conversation.confirmDeleteBody',
  'conversation.confirmDeleteTitle',
  ...
  'conversation.readerOff',
  'conversation.readerOn',
  'conversation.groupIntoConversationsOn',
  'conversation.copies',
  'conversation.copyCount_few',
  'conversation.copyCount_many',
  'conversation.copyCount_one',
  'conversation.copyDetails',
  'conversation.copyUsed',
  'conversation.date',
  'conversation.delete',
  'conversation.deselectAll',
  'conversation.diagnosticsConfidence',
  'conversation.diagnosticsCopyCount',
  'conversation.diagnosticsKind',
  'conversation.diagnosticsLogicalMessages',
  'conversation.diagnosticsNoOverrides',
  'conversation.diagnosticsNone',
  'conversation.diagnosticsOverrides',
  'conversation.diagnosticsParent',
  'conversation.diagnosticsThreadingReason',
  'conversation.diagnosticsTitle',
  'conversation.downloadAttachment',
  'conversation.exitSelection',
  'conversation.expand',
  ...
  'conversation.from',
  'conversation.hideFullHeaders',
  'conversation.hideQuotedText',
  'conversation.imagesBlocked',
  'conversation.keyboardHint',
  'conversation.label',
  'conversation.latestOwnReply',
  'conversation.listLabel',
  'conversation.loadBody',
  'conversation.loadBodyFailed',
  'conversation.loadFailed',
  'conversation.loadImages',
  'conversation.loadMore',
  'conversation.loading',
  'conversation.loadingBody',
  'conversation.lock',
  'conversation.locked',
  'conversation.logicalCount',
  'conversation.logicalCount_few',
  'conversation.logicalCount_many',
  'conversation.logicalCount_one',
  'conversation.manualActions',
  'conversation.markRead',
  'conversation.markUnread',
  'conversation.mergeConversations',
  'conversation.mergeInto',
  'conversation.mergeTargetPrompt',
  'conversation.messageCount',
  'conversation.messageCount_few',
  'conversation.messageCount_many',
  'conversation.messageCount_one',
  'conversation.messagesLabel',
  'conversation.move',
  'conversation.moveToConversation',
  'conversation.moveToConversationPrompt',
  'conversation.noBody',
  'conversation.noConversations',
  'conversation.noConversationsDesc',
  'conversation.noSubject',
  'conversation.physicalCopy',
  'conversation.read',
  'conversation.rebuildConversations',
  'conversation.rebuildDryRun',
  'conversation.reply',
  'conversation.replyAll',
  'conversation.retryLoading',
  'conversation.scopeAccountCopies',
  'conversation.scopeAllCopies',
  'conversation.scopeThisAccount',
  'conversation.scopeThisCopy',
  'conversation.scopeTitle',
  'conversation.scopeWarning',
  'conversation.scopeWholeConversation',
  'conversation.scrollToMessage',
  'conversation.selectAll',
  'conversation.selectConversationAria',
  'conversation.selectPage',
  'conversation.selectedCount_few',
  'conversation.selectedCount_many',
  'conversation.selectedCount_one',
  'conversation.seriesOff',
  'conversation.seriesSmart',
  'conversation.seriesStrict',
  'conversation.showFullHeaders',
  ...
  'conversation.you',
  'message.attachment_few',
  'message.attachment_many',
  'messageList.bulkArchived.failBody_few',
  'messageList.bulkArchived.failBody_many',
  'messageList.bulkArchived.title_few',
  'messageList.bulkArchived.title_many',
  'messageList.bulkDeleted.failBody_few',
  'messageList.bulkDeleted.failBody_many',
  'messageList.bulkDeleted.title_few',
  'messageList.bulkDeleted.title_many',
  'messageList.bulkMoved.failBody_few',
  'messageList.bulkMoved.failBody_many',
  'messageList.bulkMoved.title_few',
  'messageList.bulkMoved.title_many',
  'sidebar.hiddenFolders_few',
  'sidebar.hiddenFolders_many',
  // CE v2 candidate-only keys are selected by the CE UI/configuration surface.
  'admin.messageList.markReadDelaySeconds_few',
  'admin.messageList.markReadDelaySeconds_many',
  'admin.messageList.markReadDelaySeconds_one',
  'conversation.account',
 ...
 *       // CE v2 labels selected by runtime UI/configuration.
  'conversation.apply',
  'conversation.attachmentCount_few',
  'conversation.attachmentCount_many',
  'conversation.attachmentCount_one',
 ...
 *
 *   The test scans for the key string anywhere in *.js / *.tsx files under src/,
 ...
 *         ComposeModal.tsx:1038  title="Minimize"
 *
 *   Fix:
...
const SAME_VALUE_ALLOWED: Record<string, SameValueRule> = {
  ...
  // Account UI includes established protocol, provider, and file-format names.
  'accountUi.brandCalDAV': 'any',
  'accountUi.brandCardDAV': 'any',
  'accountUi.colorValue': 'any',
  'accountUi.contactsNumber': 'any',
  'accountUi.contactsNumber_few': 'any',
  'accountUi.contactsNumber_many': 'any',
  'accountUi.contactsNumber_one': 'any',
  'accountUi.contactsNumber_other': 'any',
  'accountUi.contactsNumber_two': 'any',
  'accountUi.contactsNumber_zero': 'any',
  'accountUi.formatGoogleCsv': 'any',
  'accountUi.formatOutlookCsv': 'any',
  'accountUi.formatVcard': 'any',
  'accountUi.general': 'any',
  'accountUi.import': 'any',
  'accountUi.intervalMinutes': 'any',
  'accountUi.intervalMinutes_few': 'any',
  'accountUi.intervalMinutes_many': 'any',
  'accountUi.intervalMinutes_one': 'any',
  'accountUi.intervalMinutes_other': 'any',
  'accountUi.intervalMinutes_two': 'any',
  'accountUi.intervalMinutes_zero': 'any',
  'accountUi.password': 'any',
  'accountUi.providersNative': 'any',
  'accountUi.resourceName': 'any',
  'accountUi.servers': 'any',
  'accountUi.services': 'any',
  'accountUi.subscriptions': 'any',
  'accountUi.transportGoogleCalendar': 'any',
  'accountUi.transportGoogleContacts': 'any',
  'accountUi.transportMicrosoft': 'any',
...
// "unused key" failures.
const DYNAMIC_KEYS = new Set([
  // Legacy catalogs retain keys used by older account/calendar flows.
  'admin.accounts.editTitle',
  'calendar.allAccounts', 'calendar.calendarActions', 'calendar.changeColor',
  'calendar.chooseColor', 'calendar.confirmCalendarDelete', 'calendar.davAccessHint',
  'calendar.disableWriteBack', 'calendar.enableWriteBack', 'calendar.hide',
  'calendar.importDone', 'calendar.importProtected', 'calendar.nativeCalendarCheckOperation',
  'calendar.nativeCalendarCreate', 'calendar.nativeCalendarDelete', 'calendar.nativeCalendarDeleteConfirm',
  'calendar.nativeCalendarName', 'calendar.nativeCalendarOperationConfirmed',
  'calendar.nativeCalendarOperationPending', 'calendar.nativeCalendarReconsent',
  'calendar.noCalendarsDiscovered', 'calendar.rename', 'calendar.renamePrompt',
  'calendar.reset', 'calendar.searchSources', 'calendar.serviceDisabled', 'calendar.show',
  'calendar.sourceSyncInterval', 'calendar.sourceSyncMinutes', 'calendar.sourceSyncTimeout',
  'calendar.toggleGroup', 'calendar.providerSync', 'calendar.providerSyncDone', 'calendar.providerSyncPartial',
  // Legacy account/contact labels retained for older translated catalogs.
  'common.manage',
  'contacts.addressBooks.allVisible', 'contacts.addressBooks.clearAll',
  'contacts.addressBooks.displayedBooks', 'contacts.addressBooks.exportGoogle',
  'contacts.addressBooks.exportOutlook', 'contacts.addressBooks.hide',
  'contacts.addressBooks.importGoogle', 'contacts.addressBooks.importVCard',
  'contacts.addressBooks.lastSynced', 'contacts.addressBooks.show',
  'contacts.addressBooks.showAll',
  'contacts.booksManager.accountLabel', 'contacts.booksManager.back',
  'contacts.booksManager.contactsCount', 'contacts.booksManager.dangerZone',
  'contacts.booksManager.dav', 'contacts.booksManager.davProviderUnavailable',
  'contacts.booksManager.deleteBook', 'contacts.booksManager.deleteNotAllowed',
  'contacts.booksManager.effectiveAccess', 'contacts.booksManager.general',
  'contacts.booksManager.hidden', 'contacts.booksManager.hiddenBadge',
  'contacts.booksManager.importExport', 'contacts.booksManager.nameLabel',
  'contacts.booksManager.neverSynced', 'contacts.booksManager.providerLabel',
  'contacts.booksManager.readWrite', 'contacts.booksManager.selectBook',
  'contacts.booksManager.sourceAccess', 'contacts.booksManager.sourceDav',
  'contacts.booksManager.sourceGoogle', 'contacts.booksManager.sourceLabel',
  'contacts.booksManager.sourceLocal', 'contacts.booksManager.sourceMicrosoft',
  'contacts.booksManager.sources', 'contacts.booksManager.sourcesHint',
  'contacts.booksManager.sync', 'contacts.booksManager.syncNow',
  'contacts.booksManager.syncing', 'contacts.booksManager.title',
  'contacts.booksManager.userAccess', 'contacts.booksManager.userAccessSource',
  'contacts.booksManager.visibility', 'contacts.booksManager.visible',
  'contacts.booksManager.writeBack', 'providers.connectGoogleHint',
  'providers.connectMicrosoftHint',
  ...
  function walk(d: string) {
    for (const entry of readdirSync(d, { withFileTypes: true })) {
      ...
      if (entry.isDirectory()) {
        ...
        // Never lint dependency or build output — only first-party source.
