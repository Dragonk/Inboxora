...
Last re-measured on `dev` at `24355f76`: backend typecheck, lint and **2418** unit tests
...
`bulk-delete` and `mark-all-read` were rows of this table and are now wired (`30372761`, `24355f76`);
the rest are reachable today and **not** wired to the provider:
