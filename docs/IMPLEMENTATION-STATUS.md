...
| P07 — native Microsoft Graph adapters | **partial** | `524a5f00`, `c30d13ba`, `a9a3f975` (contacts), `d545ff45`, `c08fb7ae`, `f4d4fac1` | Delivered: the Graph contacts adapter and sync, and the mailbox device flow. Missing: **Graph mail adapter (P07b)** — the item that blocks P12 — the **Graph calendar adapter**, and the **provider device flow**. |
