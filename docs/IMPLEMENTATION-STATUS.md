...
Last re-measured on `dev` at `de85be4d`: backend typecheck, lint and **2420** unit tests
...
`bulk-delete`, `mark-all-read` and `headers` were rows of this table and are now wired
(`30372761`, `24355f76`, `de85be4d`); the rest are reachable today and **not** wired to the provider:
