...
- **External source syncing can be paused.** ICS/webcal and CalDAV source rows now offer Pause/Resume. Pausing cancels future scheduled syncs without removing the source or its imported local calendar projection.
