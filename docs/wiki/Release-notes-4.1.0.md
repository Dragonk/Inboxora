...
- **Calendar preferences and connections are separate.** Settings → Calendar now has distinct Appearance and Calendar subscriptions sections. The latter creates local Inboxora calendars without an account or URL, and manages ICS/webcal, CalDAV and holiday subscriptions.
