...
- Ensure restored signatures remain visible and editable in both layouts, preserve plaintext signature line breaks through draft reopen and send, and include the effective signature format in idempotency identity.
