...
- Preserve canonical plaintext signature text through draft reopen and send, including line breaks, and retain replay compatibility with the preceding two-format idempotency schema.
