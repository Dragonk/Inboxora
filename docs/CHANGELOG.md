...
- **Microsoft Graph calendar delta now defaults to the documented beta contract.** Reduced events are read back in full; `GRAPH_CALENDAR_DELTA_VERSION=v1.0` is an explicit compatibility override pending live-tenant validation.
