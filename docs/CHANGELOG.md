...
- Ensure restored signatures remain visible and editable in both layouts, preserve newly typed plaintext signatures literally through draft save/reopen and send, and retain idempotency replay compatibility across prior fingerprint schemas without accepting a changed signature format.
