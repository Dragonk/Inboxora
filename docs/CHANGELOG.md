...
- Keep each reopened draft in its saved text/HTML format through SMTP MIME generation, including HTML quotes and inline images, and ensure restored signatures remain visible and editable in both layouts.
