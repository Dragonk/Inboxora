...
- **External calendar sources can be paused safely.** Pause stops scheduled upstream requests but keeps the source and imported local calendars for a later Resume; it is distinct from removal.
