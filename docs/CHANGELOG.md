...
### Fixed
- **Disabled providers stop scheduled, push-hint and manual contact syncs.** Existing authorized connections now require both the provider and API switches before their adapters can call an upstream API.
